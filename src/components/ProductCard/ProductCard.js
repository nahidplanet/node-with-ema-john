...
const ProductCard = () => {
  return (
    ...
    <div class="max-w-sm mx-auto bg-white rounded-lg shadow-md bg-[#FFE0B3]  dark:border-gray-700">
      <a href="#">
        <img class="p-8 rounded-t-lg" src="https://flowbite.com/docs/images/products/product-1.png" />
      </a>
      <div class="px-5 pb-5">
        <a href="#">
        ...
        <div class="flex justify-between items-center">
          ...
          <a href="#" class="text-white bg-gray-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
      </div>
    </div>
