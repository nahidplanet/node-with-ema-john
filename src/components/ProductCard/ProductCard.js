...
const ProductCard = () => {
  return (
    ...
    <div className="max-w-sm mx-auto bg-white rounded-lg shadow-md bg-[#FFE0B3]  dark:border-gray-700">
      <a href="#">
      ...
      <div className="px-5 pb-5">
        ...
        <div className="flex justify-between items-center">
          ...
          <a href="#" className="text-white bg-gray-900 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center  dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add to cart</a>
        </div>
      </div>
    </div>
