      ...
      <div class="grid grid-cols-[2fr,6fr,1fr] my-2 items-center  rounded-lg border shadow-md md:flex-row md:max-w-xl dark:border-gray-700 bg-[#FFE0B3] ">
        ...
        <div className="content">
          <div class="flex flex-col justify-between p-2 leading-normal">
            <h5 class="mb-1 text-md font-bold tracking-tight text-gray-900 ">Noteworthy technology acquisitions 2021</h5>
            <p class="mb-1 text-sm font-normal text-gray-700 ">Price: $12</p>
            <p class="mb-2 text-sm font-normal text-gray-700 ">Quantity: 2</p>
          </div>
        </div>
